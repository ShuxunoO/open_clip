...
if __name__ == "__main__":
    ...
    search_result_storage_path = Path("/disk1/shuxun/NFTSearch/search_results_faiss/NFT1000_mini")

    var_tuple_list = [
        ("/disk1/shuxun/NFTSearch/models/clip/openclip_finetuning/logs/2024_03_27-19_52_14-model_ViT-B-32-NFT1000_mini_dynamic_mask_all_components_order_3/checkpoints/epoch_25.pt", "ViT-B-32", Path("/disk1/shuxun/Tensor_cache/NFT1000_mini/CLIP_ViT_B_32_NFT1000_mini_finetuned_all_compontents_dynamic_mask_hardCase_ckp25"), "NFT1000_mini_CLIP_ViT_B_32_NFT1000_mini_all_compontents_dynamic_mask_hardCase_finetuned_ckp25"),
    ]
